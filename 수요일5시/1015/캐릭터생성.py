...
screen.register_shape("1015/pokemon.gif")  # 피카츄 이미지 등록
screen.title("승기와 재열이와 함께하는 코딩수업")

# 피카츄 캐릭터 생성
pokemon = turtle.Turtle()
pokemon.shape("1015/pokemon.gif")  # 피카츄 이미지를 모양으로 설정
...
def attack():
    ...
    text_turtle.write("백만볼트!", align="center", 
                     font=("맑은 고딕", 30, "bold"))
